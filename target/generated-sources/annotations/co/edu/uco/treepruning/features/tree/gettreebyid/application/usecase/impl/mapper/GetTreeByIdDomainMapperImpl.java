...
@Component
public class GetTreeByIdDomainMapperImpl implements GetTreeByIdDomainMapper {

    @Override
    public GetTreeByIdDomain toDomain(TreeEntity entity) {
        if ( entity == null ) {
            return null;
        }
        ...
        GetTreeByIdDomain getTreeByIdDomain = new GetTreeByIdDomain( id, longitude, latitude, family, sector, programming );

        return getTreeByIdDomain;
    }
