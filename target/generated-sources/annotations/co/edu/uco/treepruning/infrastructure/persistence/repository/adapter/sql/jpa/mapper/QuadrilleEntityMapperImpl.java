...
public class QuadrilleEntityMapperImpl implements QuadrilleEntityMapper {
    ...
    public QuadrilleEntity toEntity(QuadrilleJPAEntity jpaEntity) {
        ...
        quadrilleEntity.setId( jpaEntity.getId() );
        quadrilleEntity.setQuadrilleName( jpaEntity.getQuadrilleName() );
        quadrilleEntity.setManager( managerEntityMapper.toEntity( jpaEntity.getManager() ) );
