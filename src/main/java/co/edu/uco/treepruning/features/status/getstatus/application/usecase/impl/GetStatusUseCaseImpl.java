package co.edu.uco.treepruning.features.status.getstatus.application.usecase.impl;
...
import co.edu.uco.treepruning.features.status.getstatus.application.usecase.impl.mapper.GetStatusDomainMapper;
