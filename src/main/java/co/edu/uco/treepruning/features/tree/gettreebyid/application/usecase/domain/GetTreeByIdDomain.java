package co.edu.uco.treepruning.features.tree.gettreebyid.application.usecase.domain;

import java.util.UUID;

public final class GetTreeByIdDomain {
    ...
    public GetTreeByIdDomain(UUID id, String longitude, String latitude,
