package co.edu.uco.treepruning.features.status.getstatusbyid.application.usecase.impl;

import java.util.UUID;
import org.springframework.stereotype.Service;
import co.edu.uco.treepruning.features.status.getstatusbyid.application.usecase.GetStatusByIdUseCase;
import co.edu.uco.treepruning.features.status.getstatusbyid.application.usecase.rules.StatusNotFoundException;
