package co.edu.uco.treepruning.features.person.getpersonbyfilter.application.inputport.dto;
...
public final class GetPersonDTO {
    private UUID id;
    ...
    public GetPersonDTO(UUID id, String firstName, String secondName,
